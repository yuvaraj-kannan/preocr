...
def generate_release_files(version: Optional[str] = None, changelog_path: Optional[Path] = None) -> Tuple[Path, Path]:
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Generate release files from CHANGELOG.md"
    )
    parser.add_argument(
        'version',
        nargs='?',
