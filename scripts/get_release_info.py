...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description="Query release information from release files")
    parser.add_argument(
        "version",
        nargs="?",
    ...
    parser.add_argument("--list", action="store_true", help="List all available releases")
