...
from scripts.generate_release import parse_changelog, generate_release_files
...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description="Sync all release files from CHANGELOG.md")
    parser.add_argument(
        "--changelog",
        type=Path,
